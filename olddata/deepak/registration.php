...
if(isset($_POST['save_btn']))
{
  ...
  $sql = "update users set name='$name', email='$email', subject='$subject',comment='$comment' where id='$editid'";
...
if(isset($_POST['submit_btn']))
{
  ...
  $sql = "INSERT INTO customers (name, email,subject,comment)
...
<h2>Admission Form </h2>
  <form action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="file" class="form-control" id="image" placeholder="Enter student name" name="image" value="">
    </div>
